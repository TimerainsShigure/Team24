<template>
    ...
    <div class="container">
        ...
        <div class="post-details">
            ...
            <span class="published-date">Date:{{formatDate(new Date(obj.created_time))}}</span>
            <hr > <!-- 在这里添加横线 -->
            <span class="comment-count">Comments：{{commentList.length}}</span>
                ...
                <div class="comment" v-for="(item,index) in commentList" :key="index">
                    ...
                    <div class="comment-content">
                        <span class="comment-id">
                            <span>Commenter ID：{{item.u_name}}</span>
                          <span >
                        ...
                        <span class="comment-date">Date:{{formatDate(new Date(item.created_time))}}</span>
                    </div>
                </div>
                <!-- 更多评论 -->
            </div>
...
const imgSrc=ref('http://127.0.0.1:8001')
